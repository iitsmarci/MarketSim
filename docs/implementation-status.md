...
| 6-20                                    | Not started | Persistence, PWA, native platforms, advanced models, and release implementation remain future work                               |
...
Proposed Milestone 6: inflation and explicit real-versus-nominal results, the
next unimplemented quantitative capability in the product plan. Its assumptions,
event ordering, versioning, education, and chart semantics require approval and
a dedicated scope before implementation. Do not start it automatically.
